...
/**Tests to add: 
0. When there are no events that day
1. When there is no space
2. When there is a little space at the end of the day but not enough to accomodate the event*/
...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeesFullyBooked(){
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, true), 
            Arrays.asList(PERSON_C), Arrays.asList(true)));
  ...
  @Test
  public void optionalAttendeesWithConflictingTimes(){
      Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
        ...
        Arrays.asList(PERSON_B), Arrays.asList(true)));
  ...
  @Test
  public void justOptoinalAttendeesWithSpaceForTheMeeting(){
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A), Arrays.asList(true)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B), Arrays.asList(true))
    );
  ...
  @Test
  public void justOptionalAttendeesWithNoSpaceForTheMeeting(){
     Collection<Event> events = Arrays.asList(
